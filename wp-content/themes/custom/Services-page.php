...
?>
    ...
    <div class="main">
        ...
        <section class="section custom-services homepage-services  section-lg section-padding-top-none-  ">
            <div class="container"> 
                ...
                <div class="row">
                    ...
                    while (has_sub_field('services_repeater')) {
                        $soultionsPostObject = get_sub_field('services_post');
        ...
        <div class="custom-footer-rantangle">
         <section class="section cta-section section-sm   text-white" style="padding-top: 0px;">
            <div class="container">
